  ...
  return (
    ...
    >
      <motion.div
        ...
        viewport={{ once: true }}
        className="inline-flex items-center justify-center flex-wrap gap-2 border border-gray-300 p-1.5 pr-4 rounded-full"
      >
      ...
      >
        ...
        <span className="bg-linear-to-tr from-primary to-[#4d8cea] bg-clip-text text-transparent">
          digital
        </span>
        impact.
      </motion.h1>
